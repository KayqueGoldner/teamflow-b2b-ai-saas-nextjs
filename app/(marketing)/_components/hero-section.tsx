            ...
            >
              <div className="relative mt-8 -mr-56 overflow-hidden mask-b-from-55% px-2 sm:mt-12 sm:mr-0 md:mt-20">
                <div className="relative mx-auto max-w-6xl overflow-hidden rounded-2xl border bg-background p-4 shadow-lg ring-1 inset-shadow-2xs shadow-zinc-950/15 ring-background dark:inset-shadow-white/20">
                  <Image
                    className="relative hidden aspect-15/8 rounded-2xl bg-background object-contain object-top dark:block"
                    src={HeroDark}
                    alt="app screen"
                    width="2700"
                    height="1440"
                  />
                  <Image
                    className="relative z-2 aspect-15/8 rounded-2xl border border-border/25 object-contain object-top dark:hidden"
                    src={HeroLight}
                    alt="app screen"
                    width="2700"
                    height="1440"
